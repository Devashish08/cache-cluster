...
type SetRequest struct {
	...
	TtlSeconds int64  `protobuf:"varint,3,opt,name=ttl_seconds,json=ttlSeconds,proto3" json:"ttl_seconds,omitempty"` // Time-to-live in seconds. 0 means no expiration.
}
...
var file_api_v1_cache_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x06, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x31, 0x22, 0x55, 0x0a, 0x0a,
	...
	0x6e, 0x64, 0x73, 0x22, 0x0d, 0x0a, 0x0b, 0x53, 0x65, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	...
	0x6c, 0x65, 0x74, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0xa6, 0x01, 0x0a,
	0x05, 0x43, 0x61, 0x63, 0x68, 0x65, 0x12, 0x30, 0x0a, 0x03, 0x53, 0x65, 0x74, 0x12, 0x12, 0x2e,
	...
	0x63, 0x6f, 0x6d, 0x2f, 0x44, 0x65, 0x76, 0x61, 0x73, 0x68, 0x69, 0x73, 0x68, 0x30, 0x38, 0x2f,
	0x67, 0x6f, 0x2d, 0x63, 0x61, 0x63, 0x68, 0x65, 0x2d, 0x63, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72,
...
var file_api_v1_cache_proto_goTypes = []interface{}{
	(*SetRequest)(nil),     // 0: api.v1.SetRequest
	(*SetResponse)(nil),    // 1: api.v1.SetResponse
...
var file_api_v1_cache_proto_depIdxs = []int32{
	0, // 0: api.v1.Cache.Set:input_type -> api.v1.SetRequest
	2, // 1: api.v1.Cache.Get:input_type -> api.v1.GetRequest
	4, // 2: api.v1.Cache.Delete:input_type -> api.v1.DeleteRequest
	1, // 3: api.v1.Cache.Set:output_type -> api.v1.SetResponse
	3, // 4: api.v1.Cache.Get:output_type -> api.v1.GetResponse
	5, // 5: api.v1.Cache.Delete:output_type -> api.v1.DeleteResponse
